...
module.exports.chargeToken = function (options, next) {
  ...
  if(options.amounts.transactionFees !== null) {
    amounts.transactionAmount = amounts.orderAmount + options.amounts.transactionFees.amount;
    amounts.transsactionFees = {
      amount: options.amounts.transactionFees.amount || 0,
